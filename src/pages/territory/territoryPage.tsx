  ...
  return (
    <div className="relative h-full overflow-hidden">
      ...
      {fetchState === 'success' && territories.length === 0 && (
        <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 z-10 bg-cream/90 rounded-xl px-6 py-5 text-center shadow-md mx-4 max-w-xs">
          <p className="text-f16 text-navy font-semibold">아직 등록된 영토가 없어요.</p>
